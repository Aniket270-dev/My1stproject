...
const LoaderSteps = () => {
  ...
  return (
    <div className='w-full h-full flex flex-col items-center justify-center bg-gray-950 relative overflow-hidden text-white'>
      <div className='absolute inset-0 bg-linear-to-br from-blue-5000/10 via-purple-500/10 to-fuchsia-500/10 blur-3xl animate-pulse'>
      ...
      {/* Step lable - fade using transition only (no visible start) */}
