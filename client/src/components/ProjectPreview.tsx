...
export const ProjectPreview = forwardRef<ProjectPreviewRef, ProjectPreviewProps>(({project, isGenerating, device = 'desktop', showEditorPanel = true},ref) => {
    ...
    useEffect(()=>{
      ...
      }else if(event.data.type === 'CLEAN_SELECTION'){
